...
func run() -> void:
 ...
 expect(highlighted == Vector2i(12,12) and hud._inspection_connection.text.contains("falta estrada"),"inspection highlights school entrance and explains missing connection")
 sim.command("road",{"cells":[Vector2i(8,12),Vector2i(9,12),Vector2i(10,12),Vector2i(11,12),Vector2i(12,12)]})
 ...
 print("FRONTIER_HUD_RESULT checks=",checks," failures=",failures)
 hud.queue_free()
 await frames()
