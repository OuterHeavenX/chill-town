...
const SHADOW_PROFILES = preload("res://tests/shadow_profiles_approved.gd")
...
func run() -> void:
	...
	for case in [
		{"name":"baseline-strategy","profile":"baseline","size":43.0,"focus":Vector2i(13,13),"speed":1},
		{"name":"baseline-close","profile":"baseline","size":18.0,"focus":Vector2i(19,18),"speed":1},
		{"name":"msaa2_ortho-strategy","profile":"msaa2_ortho","size":43.0,"focus":Vector2i(13,13),"speed":1},
		{"name":"msaa2_ortho-close","profile":"msaa2_ortho","size":18.0,"focus":Vector2i(19,18),"speed":1},
		{"name":"msaa2_pssm2-strategy","profile":"msaa2_pssm2","size":43.0,"focus":Vector2i(13,13),"speed":1},
		{"name":"msaa2_pssm2-close","profile":"msaa2_pssm2","size":18.0,"focus":Vector2i(19,18),"speed":1}]:
