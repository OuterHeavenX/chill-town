...
Identificador: `mil_11_capitao` · Categoria: Exército
...
![Capitão](../militares/11-capitao.png)

## Função e referência

Soldado experiente com função de reunir, orientar e coordenar a companhia. Equipamento deriva da tropa com indicação moderada de patente.

## Arquivos

- [Imagem PNG](../militares/11-capitao.png)
- [Prompt efetivamente utilizado](../prompts/mil_11_capitao.txt)
