...
Identificador: `bld_12_horta` · Categoria: Construções
...
![Horta](../construcoes/12-horta.png)

## Função e referência

Canteiros próximos à casa do trabalhador. Produz legumes em ciclos curtos.

## Arquivos

- [Imagem PNG](../construcoes/12-horta.png)
- [Prompt efetivamente utilizado](../prompts/bld_12_horta.txt)
