...
Identificador: `bld_09_carvoaria` · Categoria: Construções
...
![Carvoaria](../construcoes/09-carvoaria.png)

## Função e referência

Fornos baixos com fumaça. Transforma troncos em carvão vegetal.

## Arquivos

- [Imagem PNG](../construcoes/09-carvoaria.png)
- [Prompt efetivamente utilizado](../prompts/bld_09_carvoaria.txt)
