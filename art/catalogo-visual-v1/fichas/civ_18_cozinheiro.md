...
Identificador: `civ_18_cozinheiro` · Categoria: Vida na vila
...
![Cozinheiro](../civis/18-cozinheiro.png)

## Função e referência

Prepara e serve refeições na taverna, com panela, concha e utensílios.

## Arquivos

- [Imagem PNG](../civis/18-cozinheiro.png)
- [Prompt efetivamente utilizado](../prompts/civ_18_cozinheiro-used.txt)
...
Prancha conceitual raster, sem malha 3D, rig ou frames finais. Algumas legendas adicionais ou omitidas pelo gerador, sem impedir leitura visual.
