...
Identificador: `bld_03_armazem` · Categoria: Construções
...
![Armazém](../construcoes/03-armazem.png)

## Função e referência

Galpão com caixas, sacos e pátio. Guarda recursos físicos, aceita filtros e mantém estoques reservados.

## Arquivos

- [Imagem PNG](../construcoes/03-armazem.png)
- [Prompt efetivamente utilizado](../prompts/bld_03_armazem.txt)
