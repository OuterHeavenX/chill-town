...
Identificador: `bld_11_fundicao` · Categoria: Construções
...
![Fundição](../construcoes/11-fundicao.png)

## Função e referência

Fornalha e metal incandescente. Transforma minério e carvão em barras de ferro.

## Arquivos

- [Imagem PNG](../construcoes/11-fundicao.png)
- [Prompt efetivamente utilizado](../prompts/bld_11_fundicao.txt)
