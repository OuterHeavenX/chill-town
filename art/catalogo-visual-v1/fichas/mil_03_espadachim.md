...
Identificador: `mil_03_espadachim` · Categoria: Exército
...
![Espadachim](../militares/03-espadachim.png)

## Função e referência

Espada, escudo e armadura. Infantaria resistente para tomar e manter posições. Sustenta o combate e protege flancos.

## Arquivos

- [Imagem PNG](../militares/03-espadachim.png)
- [Prompt efetivamente utilizado](../prompts/mil_03_espadachim.txt)
