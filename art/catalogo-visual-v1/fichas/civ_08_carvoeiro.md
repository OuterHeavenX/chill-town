...
Identificador: `civ_08_carvoeiro` · Categoria: Vida na vila
...
![Carvoeiro](../civis/08-carvoeiro.png)

## Função e referência

Opera os fornos da carvoaria e recolhe carvão com ferramentas e cestos.

## Arquivos

- [Imagem PNG](../civis/08-carvoeiro.png)
- [Prompt efetivamente utilizado](../prompts/civ_08_carvoeiro-used.txt)
