...
Identificador: `bld_08_pedreira` · Categoria: Construções
...
![Pedreira](../construcoes/08-pedreira.png)

## Função e referência

Frente de corte junto a uma jazida. Extrai blocos de pedra.

## Arquivos

- [Imagem PNG](../construcoes/08-pedreira.png)
- [Prompt efetivamente utilizado](../prompts/bld_08_pedreira.txt)
